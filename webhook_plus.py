...
from bot_plus import BOT, close_resources, process_update, setup_bot
...
class WebhookHandler(BaseHTTPRequestHandler):
    server_version = "TgMusicBotWebhookPlus/1.0"
    ...
    def do_GET(self):
        ...
        if parsed.path == "/healthz":
            return self._send_json(200, {"ok": True, "service": "tg-music-bot-webhook-plus", "bot": BOT[:10] + "..."})
